<?php
namespace Thirdsteplabs\Administrator\DataTable\Columns;

use Thirdsteplabs\Administrator\Validator;
use Thirdsteplabs\Administrator\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;

use Thirdsteplabs\Administrator\DataTable\Columns\Relationships\BelongsTo;
use Thirdsteplabs\Administrator\DataTable\Columns\Relationships\BelongsToMany;
use Thirdsteplabs\Administrator\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * @param array		$options
	 *
	 * @return \Thirdsteplabs\Administrator\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'Thirdsteplabs\\Administrator\\Fields\\Relationships\\BelongsTo'))
				{
