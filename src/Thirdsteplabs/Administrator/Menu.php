<?php
namespace Thirdsteplabs\Administrator;
...
class Menu {
	 ...
	 * The config instance
	 *
	 * @var \Thirdsteplabs\Administrator\Config\Factory
	 */
	 ...
	 * @param \Thirdsteplabs\Administrator\Config\Factory	$config
	 */
	...
	public function getMenu($subMenu = null)
	{
		...
		foreach ($subMenu as $key => $item)
		{
			...
			if (is_string($item))
			{
				...
				if (is_a($config, 'Thirdsteplabs\Administrator\Config\Config') && $config->getOption('permission'))
				{
