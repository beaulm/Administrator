<?php
namespace Thirdsteplabs\Administrator\Config\Model;

use Thirdsteplabs\Administrator\Config\Config as ConfigBase;
use Thirdsteplabs\Administrator\Config\ConfigInterface;
use Thirdsteplabs\Administrator\Fields\Factory as FieldFactory;
use Thirdsteplabs\Administrator\Fields\Field as Field;
use Thirdsteplabs\Administrator\Actions\Factory as ActionFactory;
...
class Config extends ConfigBase implements ConfigInterface {
	 ...
	 * @param \Thirdsteplabs\Administrator\Actions\Factory	$actionFactory
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	 */
