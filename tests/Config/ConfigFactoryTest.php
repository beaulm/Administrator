<?php
namespace Thirdsteplabs\Administrator\Tests\Config;

use Mockery as m;
use Thirdsteplabs\Administrator\Config\Factory;
...
class ConfigFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	{
		$this->validator = m::mock('Thirdsteplabs\Administrator\Validator');
	...
	{
		$configMock = m::mock('Thirdsteplabs\Administrator\Config\Model\Config');
		$factory = m::mock('Thirdsteplabs\Administrator\Config\Factory[parseType,searchMenu,getItemConfigObject]', array($this->validator, array()));
	...
	{
		$configMock = m::mock('Thirdsteplabs\Administrator\Config\Model\Config');
		$factory = m::mock('Thirdsteplabs\Administrator\Config\Factory[parseType,searchMenu]', array($this->validator, array()));
	...
	{
		$config = m::mock('Thirdsteplabs\Administrator\Config\Config');
		$config->shouldReceive('setOptions')->once();
		$factory = m::mock('Thirdsteplabs\Administrator\Config\Factory[searchMenu,getConfig]', array($this->validator, array()));
	...
	public function testModelInMenu()
	{
		...
		$factory = m::mock('Thirdsteplabs\Administrator\Config\Factory[fetchConfigFile]', array($this->validator, $config));
	...
	public function testFetchConfigWorks()
	{
		...
		$factory = m::mock('Thirdsteplabs\Administrator\Config\Factory[getPath,getPrefix]', array($this->validator, array()));
