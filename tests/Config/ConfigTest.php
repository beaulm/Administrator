...
use Mockery as m;
use Thirdsteplabs\Administrator\Config\Config;
...
class ConfigTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var string
	 */
	protected $class = 'Thirdsteplabs\Administrator\Config\Config';
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Thirdsteplabs\Administrator\Config\Config', array($this->validator, array('name' => 'model_name')))->makePartial();
	}
