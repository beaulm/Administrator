<?php
namespace Thirdsteplabs\Administrator\Tests\Config\Settings;
...
class SettingsConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Thirdsteplabs\Administrator\Config\Settings\Config', array($this->validator, array()))->makePartial();
	}
