<?php
namespace Thirdsteplabs\Administrator\Tests;
...
class MenuTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->configFactory = m::mock('Thirdsteplabs\Administrator\Config\Factory');
		$this->menu = m::mock('Thirdsteplabs\Administrator\Menu', array($this->config, $this->configFactory))->makePartial();
	}
	...
	public function testGetMenuSimpleReturnWithPermission()
	{
		...
		$itemconfig = m::mock('Thirdsteplabs\Administrator\Config\Config');
