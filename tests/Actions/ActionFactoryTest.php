...
class ActionFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->factory = m::mock('Thirdsteplabs\Administrator\Actions\Factory', array($this->validator, $this->config))->makePartial();
	}
	...
	{
		$action = m::mock('Thirdsteplabs\Administrator\Actions\Action');
