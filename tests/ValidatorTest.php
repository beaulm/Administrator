...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->validator = m::mock('Thirdsteplabs\Administrator\Validator')->makePartial();
	}
	...
	{
		$this->assertTrue($this->validator->validateEloquent(null, 'Thirdsteplabs\Administrator\Tests\EloquentStub', null));
	}
