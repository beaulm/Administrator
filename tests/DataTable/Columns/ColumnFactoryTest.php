<?php
namespace Thirdsteplabs\Administrator\Tests\DataTable\Columns;
...
class ColumnFactoryTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var string
	 */
	protected $namespace = 'Thirdsteplabs\\Administrator\\DataTable\\Columns\\';
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Thirdsteplabs\Administrator\Config\Model\Config');
		$this->db = m::mock('Illuminate\Database\DatabaseManager');
		$this->factory = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Factory', array($this->validator, $this->config, $this->db))->makePartial();
	}
	...
	{
		$stub = new ColumnStub;
		$this->factory->shouldReceive('getColumnClassName')->once()->andReturn('Thirdsteplabs\Administrator\Tests\DataTable\Columns\ColumnStub');
	...
	public function testGetIncludedColumnsReturnsColumns()
	{
		...
		$columnRelated = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
		...
		$columnNormal = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
		$columnNormal->shouldReceive('getOption')->times(4)->andReturn(false, false, 'normal', 'normal');
		$columnComputed = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
	...
	public function testGetIncludedColumnsAddsBelongsToField()
	{
		...
		$field = m::mock('Thirdsteplabs\\Administrator\\Fields\\Relationships\\BelongsTo');
