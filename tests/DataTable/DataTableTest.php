...
class DataTableTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->columnFactory = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Factory');
		$this->fieldFactory = m::mock('Thirdsteplabs\Administrator\Fields\Factory');
		$this->dataTable = m::mock('Thirdsteplabs\Administrator\DataTable\DataTable', array($this->config, $this->columnFactory, $this->fieldFactory))
								->makePartial();
	}
	...
	{
		$column = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
	...
	{
		$column1 = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
		$column1->shouldReceive('renderOutput')->once()->andReturn('rendered');
		$column2 = m::mock('Thirdsteplabs\Administrator\DataTable\Columns\Column');
